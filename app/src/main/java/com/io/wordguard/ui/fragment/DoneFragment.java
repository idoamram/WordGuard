...
public class DoneFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) rootView.findViewById(R.id.done_recyclerView);
        ...
        ContentProvider.getInstance().getDoneWords(getActivity(), new ContentProviderCallBack() {
            @Override
