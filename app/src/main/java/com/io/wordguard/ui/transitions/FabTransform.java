package com.io.wordguard.ui.transitions;
...
import com.io.wordguard.ui.util.AnimUtils;
...
public class FabTransform extends Transition {
    ...
    private static final String PROP_BOUNDS = "word_guard:fabTransform:bounds";
