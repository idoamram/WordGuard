...
public class PrivateWordsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_private_words, container, false);

        recyclerView = (RecyclerView) rootView.findViewById(R.id.my_words_recyclerView);
        ...
        ContentProvider.getInstance().getPrivateWords(getActivity(), new ContentProviderCallBack() {
            @Override
